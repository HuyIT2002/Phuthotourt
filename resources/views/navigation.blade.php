<div class="wrapper">
    <div class="nav-container d-flex  align-items-center">
        <div id="nav-home" class="nav-item nav-item-home nav-item-default d-flex justify-content-center align-items-center">
            <div class="nav-item-text"><a href="{{ route('home') }}">Trang chủ</a></div>
        </div>
        <div id="nav-about" class="nav-item nav-item-home nav-item-default d-flex justify-content-center align-items-center">
        ...
        <div class="nav-icon d-flex justify-content-center align-items-center">
            <div class="nav-icon-inner">
                <svg width="115" height="73" viewBox="0 0 115 73" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="Frame 8">
                        <path id="Ellipse 2" d="M93.9478 36.096C93.9478 56.0312 77.7871 72.1919 57.8518 72.1919C37.9166 72.1919 21.7559 56.0312 21.7559 36.096C21.7559 16.1607 37.9166 0 57.8518 0C77.7871 0 93.9478 16.1607 93.9478 36.096Z" fill="#0054A6" />
                        <path id="Ellipse 2 (Stroke)" fill-rule="evenodd" clip-rule="evenodd" d="M57.8518 70.5697C76.8911 70.5697 92.3255 55.1353 92.3255 36.096C92.3255 17.0567 76.8911 1.62229 57.8518 1.62229C38.8125 1.62229 23.3782 17.0567 23.3782 36.096C23.3782 55.1353 38.8125 70.5697 57.8518 70.5697ZM57.8518 72.1919C77.7871 72.1919 93.9478 56.0312 93.9478 36.096C93.9478 16.1607 77.7871 0 57.8518 0C37.9166 0 21.7559 16.1607 21.7559 36.096C21.7559 56.0312 37.9166 72.1919 57.8518 72.1919Z" fill="white" />
                        <path id="Vector 1" d="M41.608 24.3649L1 46.0225L35.7424 35.1937L73.1919 48.2785L114.251 26.6209L79.0575 37.9009L41.608 24.3649Z" fill="white" stroke="#0054A6" stroke-width="0.811145" stroke-linejoin="round" />
                    </g>
                </svg>
            </div>
        </div>
