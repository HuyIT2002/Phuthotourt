        ...
        <div class="content-a" id="content-a">
            ...
            <div class="image-container">
                ...
                <div class="image-item">
                    <img class="img-fluid" src="{{ asset('/public/images/home/' . $image->image_url) }}"
                            ...
                            <div class="row justify-content-center negative-margin-top">
                                ...
                                <div class="col-md-4">
                                    <div class="card" style="width: 362px; height: 542px;">
                                        <img src="{{ asset('/public/images/home/' . $post->image_url) }}"
                                            class="card-img-top card-img-custom" alt="Image">
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-title text-custom-primary text-container">
                                                {{ $post->content }}
                                            </h5>
                                            <p class="card-text text-muted text-container">{{ $post->description }}</p>
                                            <div class="d-flex gap-2 mb-3">
                                                <span
                                                    class="badge text-custom-primary custom-badge-container">{{ $post->roleCategory->parent_name ?? 'N/A' }}</span>
                                                <span
                                                    class="badge text-custom-primary custom-badge-container">{{ $post->positionCategory->parent_name ?? 'N/A' }}</span>
                                                <span
                                                    class="badge text-custom-primary custom-badge-container">{{ $post->locationCategory->parent_name ?? 'N/A' }}</span>
                                            </div>
                            ...
                            <div class="row g-4 justify-content-center container-custom-margin">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-custom">
                                        <img src="{{ asset('/public/images/home/' . $content->image_url) }}"
                                            class="card-img-top card-img-top-custom" alt="Card image">
                                        <div class="card-body card-body-custom">
                                            <h5 class="card-title card-title-custom">{{ $content->content }}</h5>
                                            <p class="card-text card-text-custom">{{ $content->description }}</p>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
