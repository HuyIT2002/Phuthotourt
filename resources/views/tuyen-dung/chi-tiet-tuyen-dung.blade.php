        ...
        <div class="header-section-5">
            <div class="container-custom-14">
                ...
                <div class="info-recrment-detail">
                    <div class="role-recruitment-detail">Nhân viên thiết kế đồ họa</div>
                    <div class="position-recruitment-detail">Nhân viên chính thức</div>
                </div>
                <div class="recruitment-details">
                    ...
                    <div class="time-recruitment">
                        <div class="icon-recruitment"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="status-recruitment-details">
                    <div class="status-text-details">Đang tuyển</div>
                </div>
                <div class="image-result">
                    <div class="image-wrapper-details">
                        <img src="{{ asset('/public/images/tuyen-dung/tuyen-dung-1.png') }}" alt="Placeholder Image" class="responsive-image">
                    </div>
                </div>
                    ...
                    <table class="details-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>Thiết kế hình ảnh, brochure, banner, poster, pano, backdrop sân khấu, các loại vé
                                        mời… và các ấn phẩm phục vụ sự kiện, truyền thông của công viên.</p>
                                    <p>Chụp hình, quay phim, dựng video đơn giản.</p>
                                    <p>Lên phác thảo, trao đổi ý tưởng với quản lý và hoàn thiện thiết kế.</p>
                                    <p>Các chi tiết về công việc được trao đổi tại buổi phỏng vấn.</p>
                                </td>
                            </tr>
                            <tr>
                                <th>Ngày làm việc</th>
                            ...
                            <tr>
                                <th>Quyền lợi</th>
                                <td>
                                    <p>Được ký hợp đồng lao động, tham gia đầy đủ chế độ BHXH.</p>
                                    <p>Thưởng tháng 13, 14, các ngày lễ, tết trong năm.</p>
                                    <p>Được phục vụ bữa ăn trưa tại nơi làm việc.</p>
                                    <p>Được trang bị đồng phục, khám sức khỏe định kỳ hàng năm.</p>
                                    <p>Được tham gia Bảo hiểm tai nạn 24/24.</p>
                                    <p>Nghỉ phép: 12 ngày phép / năm, công tác 5 năm thêm 1 ngày.</p>
                                    <p>Được tham gia miễn phí các khóa đào tạo nâng cao nghiệp vụ.</p>
                                    <p>Môi trường làm việc thân thiện, nhiều cơ hội học hỏi từ đội ngũ quản lý, nhân sự
                                        giàu kinh nghiệm, nhiệt huyết.</p>
                                    <p>Các chế độ khác: Quà sinh nhật, cưới hỏi, lì xì tết. Quà trung thu, quà Tết, quà
                                        thiếu nhi 1/6.</p>
                                    <p>Hỗ trợ ốm đau, ma chay, sinh con. Tham gia Ngày hội Gia đình, Ngày hội Tuổi thơ,
                                        hoạt động văn thể mỹ hàng năm.</p>
                                </td>
                            ...
                            <tr>
                                <th>Yêu cầu</th>
                                <td>
                                    <p>Tốt nghiệp từ Cao đẳng chuyên ngành Mỹ thuật, Đồ họa.</p>
                                    <p>Sử dụng thành thạo các phần mềm thiết kế (Photoshop, Corel, Illustrator…).</p>
                                    <p>Có khả năng quay và dựng video hấp dẫn người xem.</p>
                                    <p>Sử dụng thành thạo máy ảnh, máy quay, flycam...</p>
                                    <p>Có khiếu thẩm mỹ, sáng tạo, chủ động trong công việc.</p>
                                    <p>Có thể làm việc cuối tuần, lễ tết theo đặc thù kinh doanh Công viên Giải trí.</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Thông tin ứng tuyển:
                                    <p>Ứng viên vui lòng gửi CV đến email: <a href="mailto:tuyendung@damsenpark.vn">tuyendung@damsenpark.vn</a>.</p>
                                    <p>Hoặc nộp hồ sơ trực tiếp tại Trụ sở Văn phòng Công ty: 15 đường số 2, cư xá Lữ
                                        Gia, P. 15, Quận 11.</p>
                ...
                <div class="container-recruitment-cv">
                    ...
                    <div class="container-map">
                        <div class="work-experience">
                            ...
                            <div class="input-box">
                                <textarea class="input-textarea" placeholder="Những nơi đã từng làm việc trước đây"></textarea>
                            </div>
                        </div>
