<div class="wrapper">
    <div class="nav-container d-flex  align-items-center">
        <div id="nav-home"
            class="nav-item nav-item-home nav-item-default d-flex justify-content-center align-items-center">
